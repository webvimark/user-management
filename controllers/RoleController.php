...
use wpler\modules\UserManagement\models\rbacDB\search\RoleSearch;
...
class RoleController extends AdminDefaultController
{
	 ...
	 * @var Role
	 */
	public $modelClass = 'wpler\modules\UserManagement\models\rbacDB\Role';

	/**
	 * @var RoleSearch
	 */
	public $modelSearchClass = 'wpler\modules\UserManagement\models\rbacDB\search\RoleSearch';
